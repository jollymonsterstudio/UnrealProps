...
AProps01Character::AProps01Character()
{
...
void AProps01Character::BeginPlay()
{
	Super::BeginPlay();

	LeftMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AProps01Character::OnAttackHit);
	RightMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AProps01Character::OnAttackHit);
...
void AProps01Character::Tick(float DeltaTime)
{
...
void AProps01Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AProps01Character::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AProps01Character::MoveRight);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AProps01Character::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AProps01Character::LookUpAtRate);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AProps01Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AProps01Character::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AProps01Character::OnResetVR);

	// attack functionality
	PlayerInputComponent->BindAction("Punch", IE_Pressed, this, &AProps01Character::PunchAttack);
	PlayerInputComponent->BindAction("Kick", IE_Pressed, this, &AProps01Character::KickAttack);

	PlayerInputComponent->BindAction("FireTrace", IE_Pressed, this, &AProps01Character::FireLineTrace);
	
}

void AProps01Character::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AProps01Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}

void AProps01Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}

void AProps01Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AProps01Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AProps01Character::MoveForward(float Value)
{
...
void AProps01Character::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) && IsKeyboardEnabled )
	{
...
bool AProps01Character::GetIsAnimationBlended()
{
	return IsAnimationBlended;
}

void AProps01Character::SetIsKeyboardEnabled(bool Enabled)
{
	IsKeyboardEnabled = Enabled;
}

EAttackType AProps01Character::GetCurrentAttack()
{
	return CurrentAttack;
}

void AProps01Character::PunchAttack()
{
	AttackInput(EAttackType::MELEE_FIST);
}

void AProps01Character::KickAttack()
{
	AttackInput(EAttackType::MELEE_KICK);
}

void AProps01Character::AttackInput(EAttackType AttackType)
{
...
void AProps01Character::AttackStart()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AProps01Character::AttackEnd()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AProps01Character::OnAttackHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
...
void AProps01Character::FireLineTrace()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AProps01Character::Log(ELogLevel LogLevel, FString Message)
{
	Log(LogLevel, Message, ELogOutput::ALL);
}

void AProps01Character::Log(ELogLevel LogLevel, FString Message, ELogOutput LogOutput)
{
