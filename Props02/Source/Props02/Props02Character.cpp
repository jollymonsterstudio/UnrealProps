...
AProps02Character::AProps02Character()
{
...
void AProps02Character::BeginPlay()
{
	Super::BeginPlay();

	LeftMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AProps02Character::OnAttackHit);
	RightMeleeCollisionBox->OnComponentHit.AddDynamic(this, &AProps02Character::OnAttackHit);
...
void AProps02Character::Tick(float DeltaTime)
{
...
void AProps02Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AProps02Character::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AProps02Character::MoveRight);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AProps02Character::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AProps02Character::LookUpAtRate);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AProps02Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AProps02Character::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AProps02Character::OnResetVR);

	// attack functionality
	PlayerInputComponent->BindAction("Punch", IE_Pressed, this, &AProps02Character::PunchAttack);
	PlayerInputComponent->BindAction("Kick", IE_Pressed, this, &AProps02Character::KickAttack);

	PlayerInputComponent->BindAction("LightAttackModifier", IE_Pressed, this, &AProps02Character::LightAttackStart);
	PlayerInputComponent->BindAction("LightAttackModifier", IE_Released, this, &AProps02Character::LightAttackEnd);

	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Pressed, this, &AProps02Character::StrongAttackStart);
	PlayerInputComponent->BindAction("StrongAttackModifier", IE_Released, this, &AProps02Character::StrongAttackEnd);

	PlayerInputComponent->BindAction("FireTrace", IE_Pressed, this, &AProps02Character::FireLineTrace);
	
}

void AProps02Character::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AProps02Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}

void AProps02Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}

void AProps02Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AProps02Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AProps02Character::MoveForward(float Value)
{
...
void AProps02Character::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) && IsKeyboardEnabled )
	{
...
bool AProps02Character::GetIsAnimationBlended()
{
	return IsAnimationBlended;
}

void AProps02Character::SetIsKeyboardEnabled(bool Enabled)
{
	IsKeyboardEnabled = Enabled;
}

EAttackType AProps02Character::GetCurrentAttack()
{
	return CurrentAttack;
}

void AProps02Character::PunchAttack()
{
	AttackInput(EAttackType::MELEE_FIST);
}

void AProps02Character::KickAttack()
{
	AttackInput(EAttackType::MELEE_KICK);
}

void AProps02Character::AttackInput(EAttackType AttackType)
{
	...
	else if (IsAttackLight && !IsAttackStrong) 
	{
...
void AProps02Character::AttackStart()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AProps02Character::AttackEnd()
{
	//Log(ELogLevel::INFO, __FUNCTION__);
...
void AProps02Character::LightAttackStart()
{
	IsAttackLight = true;
}

void AProps02Character::LightAttackEnd()
{
	IsAttackLight = false;
}

void AProps02Character::StrongAttackStart()
{
	IsAttackStrong = true;
}

void AProps02Character::StrongAttackEnd()
{
	IsAttackStrong = false;
}

void AProps02Character::OnAttackHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
...
void AProps02Character::FireLineTrace()
{
	Log(ELogLevel::WARNING, __FUNCTION__);
...
void AProps02Character::Log(ELogLevel LogLevel, FString Message)
{
	Log(LogLevel, Message, ELogOutput::ALL);
}

void AProps02Character::Log(ELogLevel LogLevel, FString Message, ELogOutput LogOutput)
{
